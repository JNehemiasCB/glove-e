...
@dso_cache = dso_local local_unnamed_addr global [538 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 3093185, ; hash 0x2f32c1, from name: aot-glove-e
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1238196572, ; hash 0x49cd615c, from name: glove-e
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 136
	...
	%struct.DSOCacheEntry {
		i64 1255024768, ; hash 0x4ace2880, from name: glove-e.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 139
	...
	%struct.DSOCacheEntry {
		i64 1329891963, ; hash 0x4f448a7b, from name: aot-glove-e.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 148
	...
	%struct.DSOCacheEntry {
		i64 1891420404, ; hash 0x70bcc8f4, from name: libaot-glove-e.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 216
	...
	%struct.DSOCacheEntry {
		i64 2815655014, ; hash 0xa7d37c66, from name: libaot-glove-e
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 350
