...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670888, ; uint32_t jnienv_initialize_method_token (0x6001da8)
	i32 100670887, ; uint32_t jnienv_registerjninatives_method_token (0x6001da7)
...
@dso_cache = dso_local local_unnamed_addr global [538 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 697548879965180427, ; hash 0x9ae3102b3cbd20b, from name: glove-e
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 19
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1310925459653707720, ; hash 0x123157c28dacc7c8, from name: aot-glove-e.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 40
	...
	%struct.DSOCacheEntry {
		i64 11785448259234369259, ; hash 0xa38e52bff2690eeb, from name: glove-e.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 342
	...
	%struct.DSOCacheEntry {
		i64 11821833330010219293, ; hash 0xa40f96c76521e31d, from name: aot-glove-e
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 345
	...
	%struct.DSOCacheEntry {
		i64 14652460251755785343, ; hash 0xcb57fef7876f2c7f, from name: libaot-glove-e.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 429
	...
	%struct.DSOCacheEntry {
		i64 17844345769312430246, ; hash 0xf7a3d9ef0d1ca8a6, from name: libaot-glove-e
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-glove-e.dll.so
		ptr null; void* handle (0x0)
	}, ; 514
...
@.env.3 = private unnamed_addr constant [37 x i8] c"359682f3-65d7-4db0-a689-63ce418b100b\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.glovee\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [22 x i8] c"libaot-glove-e.dll.so\00", align 16
